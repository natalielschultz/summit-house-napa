...
// Mock monthly rates respect the live pricing floors:
// Peak (Apr–Nov): $14,000–$18,000   |   Off-Peak (Dec–Mar): $12,000–$14,000
const mockData: MonthAvailability[] = [
  { month: "April", year: 2026, status: "booked", rate: null },
  { month: "May", year: 2026, status: "booked", rate: null },
  { month: "June", year: 2026, status: "available", rate: 16000 },
  { month: "July", year: 2026, status: "available", rate: 18000 },
  { month: "August", year: 2026, status: "booked", rate: null },
  { month: "September", year: 2026, status: "reserved", rate: null },
  { month: "October", year: 2026, status: "available", rate: 15000 },
  { month: "November", year: 2026, status: "available", rate: 14000 },
  { month: "December", year: 2026, status: "available", rate: 13000 },
  { month: "January", year: 2027, status: "available", rate: 12000 },
  { month: "February", year: 2027, status: "reserved", rate: null },
  { month: "March", year: 2027, status: "available", rate: 13000 },
];
